...
For a conceptual overview of the available Kubernetes API authorization options in AKS, see [Kubernetes API authorization concepts](concepts-kubernetes-api-authorization.md).
...
* [Kubernetes API authorization concepts for AKS](concepts-kubernetes-api-authorization.md)
...
[kubernetes-rbac]: concepts-kubernetes-api-authorization.md
