...
| [Container Networking Agent](/azure/aks/container-networking-agent-overview) | Use the Container Networking Agent—an AI-powered, evidence-based AKS cluster extension—to diagnose and troubleshoot networking issues in your AKS cluster. |
