...
For more information, see [Use Microsoft Entra ID authorization for the Kubernetes API](/azure/aks/manage-entra-id-authorization) and [Secure your cluster with Azure Policy](/azure/aks/use-pod-security-on-azure-policy).
